...
cv_evaluation_df = pd.read_csv('CNN/Full data CV evaluation with TPES.csv')
...
filename = f"CNN/RF_full_TPES5.pkl"
...
for filename in os.listdir(folder_path):
    if 'te' in filename and 'full_alt' in filename:
...
metrics_df.to_csv("CNN/evaluation_metrics_lockbox_full_cnn_alt.csv", index=False)
