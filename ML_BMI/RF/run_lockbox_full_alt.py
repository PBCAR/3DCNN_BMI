...
cv_evaluation_df = pd.read_csv('HandCraft/Full data CV evaluation with TPES.csv')
...
filename = f"HandCraft/RF_full_TPES{best_fold}.pkl"
...
for filename in os.listdir(folder_path):
    if 'te' in filename and 'full' in filename:
        test_cv=pd.read_csv(folder_path+filename)
    if 'va' in filename and 'full' in filename:
...
metrics_df.to_csv("HandCraft/evaluation_metrics_lockbox_full_alt.csv", index=False)
