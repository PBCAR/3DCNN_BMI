...
cv_evaluation_df = pd.read_csv('CNN/Covariate data CV evaluation with TPES.csv')
...
filename = f"CNN/RF_cov_TPES5.pkl"
...
for filename in os.listdir(folder_path):
    if 'te' in filename and 'cov_alt' in filename:
...
metrics_df.to_csv("CNN/evaluation_metrics_lockbox_cov_cnn_alt.csv", index=False)
